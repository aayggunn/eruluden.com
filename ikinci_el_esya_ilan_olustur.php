    ...
    <div class="wrapper">
        <header class="baslik">
			...
			<article class="alan">
                <div class="olustur">
                    <div class="duzen">
                    <a href = "ikinci_el_esya.php"><div class="buton">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_SESSION["uye_id"]) && is_numeric($_SESSION["uye_id"])) {
        ...
        $ekle_ilanlar1 = $baglanti->prepare("INSERT INTO eruluden_ikinci_el_ilanlar (uye_id, ilan_baslik, ilan_yazi, ilan_fiyat, ilan_resim) VALUES (?, ?, ?, ?, ?)");
...
<div class="form-container">
    <form action="ikinci_el_esya_ilan_olustur.php" method="POST" enctype="multipart/form-data">
        ...
        <label for="price">İlan Fiyatı Girin:</label>
