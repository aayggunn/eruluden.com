			...
			<article>
				...
				<?php
					...
					if (isset($_GET['id']) && is_numeric($_GET['id'])) {
						...
						$ilan_detay = $baglanti->prepare("SELECT i.ilan_baslik, i.ilan_tarih, i.ilan_yazi, u.kullanici_adi, i.ilan_fiyat FROM eruluden_ev_arkadasi_ilanlar i INNER JOIN eruluden_uyeler u ON i.uye_id = u.uye_id WHERE i.ilan_id = ?");
