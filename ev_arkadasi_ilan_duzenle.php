        ...
        <header class="baslik">
			...
			<?php
				...
				if (isset($_GET['id']) && is_numeric($_GET['id'])) {
					...
					$duzenlenecek_ilan = $baglanti->prepare("SELECT ilan_baslik, ilan_yazi, ilan_fiyat FROM eruluden_ev_arkadasi_ilanlar WHERE ilan_id = ? AND uye_id = ?");
				...
				if (isset($_POST['duzenle'])) {
					...
					$guncelle_sorgu = $baglanti->prepare("UPDATE eruluden_ev_arkadasi_ilanlar SET ilan_baslik = ?, ilan_yazi = ?, ilan_fiyat = ? WHERE ilan_id = ? AND uye_id = ?");
			...
			?>
				...
				<form action="ev_arkadasi_ilan_duzenle.php?id=<?php echo $ilan_id; ?>" method="post">
					<label for="ilan_baslik"  class="a">Başlık:</label>
					<input type="text" name="ilan_baslik" id="ilan_baslik" value="<?php echo $ilan_baslik; ?>">
					<br><br>
					<label for="ilan_yazi"  class="a">Açıklama:</label>
					<textarea name="ilan_yazi" id="ilan_yazi"><?php echo $ilan_yazi; ?></textarea>
					<br><br>
					<label for="ilan_fiyat"  class="a">Fiyat:</label>
