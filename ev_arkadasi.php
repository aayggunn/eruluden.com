...
<head>
    ...
    <title>Erülüden | Ev Arkadaşı</title>
	<link rel="icon" href="logo1.jpg" type="image/x-icon" />
    <link rel="stylesheet" href="ev_arkadasi.css">
...
<body>
    <div class="wrapper">
        <header class="baslik">
			...
			<article class="alan">
                <div class="arkadas-kutu">
                    <div class="arkadas">
                    <a href = "ev_arkadasi_ilan_olustur.php"><div class="buton">
              ...
              <?php
					...
					$toplam = $baglanti->query("SELECT count(*) FROM eruluden_ev_arkadasi_ilanlar");
					$sayfa_sayisi = $toplam->fetch_row()[0]; // Sayfa sayısını direkt olarak alıyoruz
					$toplam->close();

					$ilan = $baglanti->prepare("SELECT i.ilan_id, i.ilan_baslik, i.ilan_tarih, i.ilan_yazi, u.kullanici_adi, i.ilan_fiyat, i.ilan_resim FROM eruluden_ev_arkadasi_ilanlar i INNER JOIN eruluden_uyeler u ON i.uye_id = u.uye_id ORDER BY i.ilan_id DESC LIMIT ? OFFSET ?");
                    ...
                    <img src='{$ilan_resim}' alt=''>
							...
							echo "<a href='ev_arkadasi_ilan.php?id={$ilan_id}'>Devamını Göster</a>
							</div>";
					}
