        ...
        <header class="baslik">
			...
			<?php
				...
				if (isset($_GET['id']) && is_numeric($_GET['id'])) {
					...
					$duzenlenecek_ilan = $baglanti->prepare("SELECT ilan_baslik, ilan_yazi, ilan_fiyat FROM eruluden_ikinci_el_ilanlar WHERE ilan_id = ? AND uye_id = ?");
				...
				if (isset($_POST['duzenle'])) {
					...
					$guncelle_sorgu = $baglanti->prepare("UPDATE eruluden_ikinci_el_ilanlar SET ilan_baslik = ?, ilan_yazi = ?, ilan_fiyat = ? WHERE ilan_id = ? AND uye_id = ?");
			...
			?>
				...
				<form action="ikinci_el_esya_ilan_duzenle.php?id=<?php echo $ilan_id; ?>" method="post">
					...
					<br><br>
					<input type="submit" name="duzenle" value="Düzenle" class = "button">
				</form>
				</div>
