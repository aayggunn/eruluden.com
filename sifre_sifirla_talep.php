    ...
    if ($stmt = $baglanti->prepare($kontrol_sorgu)) {
        ...
        if ($stmt->num_rows > 0) {
            ...
            try {
                ...
                $mail->Body = "Şifre sıfırlama talebinde bulundunuz. Lütfen <a href='http://yourdomain.com/sifre-sifirla.php?email=$email'>bu bağlantıya</a> tıklayarak şifrenizi sıfırlayın.";
