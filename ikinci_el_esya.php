...
<head>
    ...
    <link rel="stylesheet" href="ikinci_el_esya.css">
...
<body>
    <div class="wrapper">
        <header class="baslik">
			...
			<article class="alan">
                <div class="ikinci-kutu">
                    <div class="ikinci">
                    <a href = "ikinci_el_esya_ilan_olustur.php"><div class="buton">
...
while ($ilan->fetch()) {
    ...
    echo "<a href='ikinci_el_esya_ilan.php?id={$ilan_id}'>Devamını Göster</a>
    </div>";
}
