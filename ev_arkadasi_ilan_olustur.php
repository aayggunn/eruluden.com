    ...
    <div class="wrapper">
        <header class="baslik">
			...
			<article class="alan">
                <div class="olustur">
                    <div class="duzen">
                    <a href = "ev_arkadasi.php"><div class="buton">
				...
				<?php
					...
					if ($_SERVER["REQUEST_METHOD"] == "POST") {
						...
						if (isset($_SESSION["uye_id"]) && is_numeric($_SESSION["uye_id"])) {
							...
							$ekle_ilanlar1 = $baglanti->prepare("INSERT INTO eruluden_ev_arkadasi_ilanlar (uye_id, ilan_baslik, ilan_yazi, ilan_fiyat, ilan_resim) VALUES (?, ?, ?, ?, ?)");
					...
					<div class="form-container">
						<form action="ev_arkadasi_ilan_olustur.php" method="POST" enctype="multipart/form-data">
							<label for="title" class="a">İlan Başlığı Girin:</label>
							<input type="text" id="title" name="baslik" required>

							<label for="content" class="a">İlan İçeriği Girin:</label>
							<textarea id="content" name="yazi" rows="4" required></textarea>

							<label for="price" class="a">İlan Fiyatı Girin:</label>
							<input type="text" id="price" name="fiyat" required>

							<label for="image" class="a">İlan Resmi Yükleyin:</label>
