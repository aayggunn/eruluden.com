...
<head>
    ...
    <link rel="stylesheet" href="burslar.css">
                    ...
                    <div class="sidemenu">
                        <div class="menu1">
                            <ul class="menu-links">
                                ...
                                <li class="nav-link">
                                 <a class="side" href="arama_kutusu.php">
			...
			<article class="alan">
				...
				<?php
					...
					foreach ($html->find('.post') as $element) {
						...
						$stajLink = 'https://www.guncel-egitim.org/' . $element->href;
						
						echo '<div class="d">';
						 echo '<div class="resim">';
						echo "<img src='burs.jpeg' alt=''>"; // Resim kaynağını buraya ekleyin
						echo '</div>';
						echo '<div class="staj">';
