...
<head>
	...
	<title>Erülüden | Ev Arkadaşı Arama - Bulma</title>
	<link rel="icon" href="logo1.jpg" type="image/x-icon" />
	<link rel="stylesheet" href="eev_arkadasi.css">
		...
		<div class="navbar">
			...
			<article>
              ...
              <?php
					...
					$ilan = $baglanti->prepare("SELECT i.ilan_id, i.ilan_baslik, i.ilan_tarih, i.ilan_yazi, u.kullanici_adi, i.ilan_fiyat FROM eruluden_ev_arkadasi_ilanlar i INNER JOIN eruluden_uyeler u ON i.uye_id = u.uye_id ORDER BY i.ilan_id DESC LIMIT ? OFFSET ?");
					...
					while ($ilan->fetch()) {
						...
						echo "<div class='ilan'>
							...
							<p>{$ilan_yazi} ... <a href='eev_arkadasi_ilan.php?id={$ilan_id}'>Devamını Göster</a></p>";
