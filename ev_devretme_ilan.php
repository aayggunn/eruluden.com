...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    $ilan_detay = $baglanti->prepare("SELECT i.ilan_baslik, i.ilan_tarih, i.ilan_yazi, u.kullanici_adi, i.ilan_fiyat, i.ilan_resim, i.uye_id FROM eruluden_ev_devretme_kiralama_ilanlar i INNER JOIN eruluden_uyeler u ON i.uye_id = u.uye_id WHERE i.ilan_id = ?");
